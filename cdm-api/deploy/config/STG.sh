...
export TFA_SERVICE_NAME="tfaqa.trueffect.com"
...
export TRAFFICKING_WSDL_URL="https:\/\/trafficking-qa.trueffect.com\/1.1\/TraffickingService.xamlx?wsdl"
export DELIVERY_URL="https:\/\/truconnect-qa.trueffect.com\/TruAPI\/Delivery\/"
export MEASUREMENT_URL='https:\/\/measurement-mstest.trueffect.com'
export TRUQ_URL="https:\/\/truconnect-qa.trueffect.com\/TruApi\/Client\/TruQ\/InsertMessageToQueue"

# Internal Addresses (for TruAPI infrastructure)
export OAUTH_URL="https:\/\/truapi-qa.trueffect.com\/oauth"
export PUBLIC_URL="https:\/\/truapi-qa.trueffect.com\/cms"
