 ...
 * @author Jeff Fryer
 */
public class MetricsPersistenceContextMock implements PersistenceContext {

    private static Long globalSequence = 0L;

    private static final MetricsPersistenceContextMyBatis MY_BATIS_BUSSINESS_LOGIC = mock(MetricsPersistenceContextMyBatis.class);
