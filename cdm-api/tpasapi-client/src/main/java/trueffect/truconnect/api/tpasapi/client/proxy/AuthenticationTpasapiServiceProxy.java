...
import trueffect.truconnect.api.tpasapi.model.Authentication;
...
public class AuthenticationTpasapiServiceProxy {
    ...
    public AuthenticationTpasapiServiceProxy(String authenticationUrl, String userName, String password) throws Exception {
