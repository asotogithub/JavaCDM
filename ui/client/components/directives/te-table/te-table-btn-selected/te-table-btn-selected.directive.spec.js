...
describe('Directive: teTableBtnSelected', function () {
    var element,
      scope;
    ...
    it('should only enable button when table rows available and has selected rows', inject(function ($compile) {
        var $table;
        ...
        element = $compile(angular.element(
            ...
            '  <te-table-btns>' +
            '    <button id="btn" data-te-table-btn-selected>foobar</button>' +
            '  </te-table-btns>' +
            '</te-table>'
        ))(scope);
        scope.$apply();
