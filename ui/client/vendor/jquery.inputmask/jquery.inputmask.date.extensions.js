    ...
    return $.extend($.inputmask.defaults.definitions, {
        ...
        "mm/dd/yyyy": {
            ...
            regex: {
                ...
                val2: function(separator) {
                    var escapedSeparator = $.inputmask.escapeRegex.call(this, separator);
                    return new RegExp("((0[0-9]|1[0123])" + escapedSeparator + "(0[0-9]|[123][0-9]))|((0[13-9]|1[0123])" + escapedSeparator + "30)|((0[13578]|1[023])" + escapedSeparator + "31)");
                },
                val1pre: new RegExp("[01]"),
                val1: new RegExp("(0[0-9]|1[0-9])")
            },
            leapday: "02/29/",
            onKeyDown: function(e, buffer, caretPos, opts) {
                var $input = $(this);
