...
var mediaBootstrap = function() {
    var clickthrough,
        ...
        generatedIds,
        ioId,
        logger = require('../utilities/log-to-file.spec.js').getLogger('media-bootstrap'),
        mediaBuyId,
        path = require('path'),
        placementId,
        placement3rdId,
    ...
    this.setupMediaData = function (campaignName, creatives, ioName, ioNumber, newPackage, placementName, newTagInjection) {
        ...
        var createPlacement = function (size3rd) {
            request({
                ...
                .then(function (body) {
                    ...
                    callCreatePackage(body, size3rd);
                })
                .catch(function (err) {
                    logger.error(err);
                });
        ...
        var callCreatePackage = function (size, size3rd) {
            request({
                method: 'POST',
                            ...
                            'placements': [
                                {
                                    ...
                                    'ioId': ioId,
                                    'isChild': false,
                                    'name': newPackage.placement[0].name,
                                ...
                                },
                                {
                                    ...
                                    'ioId': ioId,
                                    'isChild': false,
                                    'name': newPackage.placement[1].name,
                                    'packageName': newPackage.name,
                                    'rate': 1,
                                    'rateType': {
                                        'KEY': 'CPM',
                ...
                .then(function (body) {
                    logger.info('Package Id : ', body.packages[0].id);
                    callCreatePlacement(size, size3rd)
                })
                .catch(function (err) {
...
module.exports = new mediaBootstrap();
